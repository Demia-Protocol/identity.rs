...
pub mod demia {
  //! The Demia DID method implementation for the IOTA ledger.

  pub use identity_demia_core::*;
}
...
pub mod prelude {
  ...
  pub use identity_demia_core::IotaClientExt;
  #[cfg(feature = "client")]
  #[cfg_attr(docsrs, doc(cfg(feature = "client")))]
  pub use identity_demia_core::IotaIdentityClient;
  #[cfg(feature = "client")]
  #[cfg_attr(docsrs, doc(cfg(feature = "client")))]
  pub use identity_demia_core::IotaIdentityClientExt;
